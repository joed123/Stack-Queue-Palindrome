...
// function name: void* list_top(struct list* list){
// purpose: return the vlue at te top of the list
// accepts: the list
...
// function name: void* list_pop(struct list* list){
// purpose: pops the top of the list and moves the the next value to the top
// accepts: the list
//returns: the value at the head of the list
void* list_pop(struct list* list){
  struct node* temp_pointer = list -> head; 
  list -> head = list -> head -> next;
  void* temp_value = temp_pointer -> val;
  free(temp_pointer);
  return temp_value;
}

// function name: int listis_empty(struct list* list){
// purpose: checks if te list is empty
// accepts: the list
//returns: if empty return 1 otherwise return 0
int listis_empty(struct list* list){
  if (list -> head == NULL){
    return 1;
  }
  else{
